        ...
        >
          <Box sx={{ flex: 1 }}>
           <Typography
            ...
            >
              Review submitted timesheets, keep approvals moving, and make sure your team gets clear feedback quickly.
            </Typography>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} md={4}>
          <DashboardCard
            ...
            color="#2E7D32"
            onClick={() => navigate("/manager/timesheets?status=APPROVED")}
            delay={160}
          />
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <DashboardCard
            ...
            color="#D32F2F"
            onClick={() => navigate("/manager/timesheets?status=REJECTED")}
            delay={240}
          />
        </Grid>
      </Grid>
